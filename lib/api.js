...
import {chain, groupBy, isEqual, keyBy, xor} from 'lodash-es'
...
export async function getMemberComputedActivity(req, res) {
  const computedActivity = await Member.computeMemberActivity(req.rawUser._id)
  res.send(computedActivity)
}
