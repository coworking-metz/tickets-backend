...
export function base62IntToChar(n) {
...
export function base62IntToString(n) {
...
export function generateBase62Part() {
  return base62IntToString(Number.parseInt(Math.random().toString().slice(2, 17), 10)).padStart(10, '0')
}
