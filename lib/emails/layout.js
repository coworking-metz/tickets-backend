...
<table role="presentation" cellspacing="0" cellpadding="0" border="0">
  ${prepend}
  <tr>
    <td class="button-td button-td-primary" style="border-radius: 9999px; background: ${theme.meatBrown};">
      <a class="button-a button-a-primary" href="${href}" style="background: ${theme.meatBrown}; border: 1px solid ${theme.meatBrown}; font-family: sans-serif; font-weight: bold; text-decoration: none; padding: 12px 24px; color: ${theme.black}; display: block; border-radius: 9999px;">${text}</a>
    </td>
  </tr>
  ${append}
</table>`
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
  ...
  <tr>
    <td style="padding: 0px 16px;">
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
          <td style="padding: 12px 16px; border-radius: 8px; color: ${theme.white}; background-color: #858588;">
            ${text}
          </td>
        </tr>
      </table>
...
export const helpAlert = (prepend = spacer(24), append = spacer(24)) => alert(`🙋‍♀️ Si vous rencontrez le moindre problème, contactez&#8209;nous à <a style="display: inline-block; font-weight: medium; text-decoration: underline; color: ${theme.meatBrown}" href="mailto:contact@coworking-metz.fr">contact@coworking&#8209;metz.fr</a> ou répondez à cet e-mail. Nous sommes là pour vous aider.`, prepend, append)
      ...
      <tr>
        <td style="${style.tableDelete}; width: 100%" align="center">
          <a style="display: block;" href="https://www.coworking-metz.fr" target="_blank">
            <img alt="Le Poulailler - Coworking Metz"
              title="Le Poulailler - Coworking Metz banner"
              width="${imageWidth}"
              height="${imageWidth * imageRatio}"
              border="0"
