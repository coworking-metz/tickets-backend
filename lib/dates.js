...
function getPeriods(periodType, from, to) {
  return periodsBuilders[periodType](from, to)
}

module.exports = {getPeriods, getDays, getWeeks, getMonths, getYears, getYesterdayRange, getLastWeekRange, getLastMonthRange, getLastYearRange, getAllTimeRange, formatDate, parseFromTo}
