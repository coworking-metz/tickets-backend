...
async function computeStats() {
  ...
  const yesterdayDate = await computeRangeData(getYesterdayRange(today))
  ...
  return {
    nb_coworkers_veille: yesterdayDate.coworkersCount,
    ...
    nb_jours_coworkes_veille: yesterdayDate.coworkedDaysCount,
