...
const formatICALEvent = event => {
  ...
  const trimmedDescription = descriptionWithoutLonelyUrls
    ...
    .replaceAll(/(https?:\/\/\S+)/g, '[$1]($1)') // Replace remaining urls by a markdown link with the url as text
    .trim()
 ...
 * A lonely URL is a URL that is not part of a Markdown link or image, and that is not prefixed by a semicolon and a space like "Example: URL"
 *
