...
export const getCurrentState = async () => {
  ...
  return {
    ...
    airConditioners: {
      north: {
        active: isAirConditioningActive(airConditionerNorth?.state),
        targetTemperature: airConditionerNorth?.attributes?.temperature,
        currentTemperature: airConditionerNorth?.attributes?.current_temperature,
        fanSpeed: airConditionerNorth?.attributes?.fan_mode
      },
      south: {
        active: isAirConditioningActive(airConditionerSouth?.state),
        targetTemperature: airConditionerSouth?.attributes?.temperature,
        currentTemperature: airConditionerSouth?.attributes?.current_temperature,
        fanSpeed: airConditionerSouth?.attributes?.fan_mode
      }
    },
    flexDesks: {
      a: {
