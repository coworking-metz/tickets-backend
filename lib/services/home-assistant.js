...
export const getCurrentState = async () => {
  const entities = await getEntitiesState(new Set([BLUE_PHONE_BOOTH_ID, ORANGE_PHONE_BOOTH_ID, DECK_DOOR_ID]))
...
export const unlockDeckDoor = async () => {
  ...
  if (!changedState) {
    throw createError(503, 'Le déverouillage de la porte de la terrasse a échoué.')
  }
